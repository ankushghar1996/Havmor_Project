...
public class Asset_DF_Confirmation_By_Depo_Main {
	...
	public WebElement getDF_Confirmation_By_Depo() {
		return DF_Confirmation_By_Depo;
	}
	...
	@FindBy(how = How.XPATH, using = "//p[normalize-space()='DF Confirmation By Depot']")
	private WebElement DF_Confirmation_By_Depo;

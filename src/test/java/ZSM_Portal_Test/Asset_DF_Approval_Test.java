...
import ZSM_Portal_Main.Asset_DF_Approval_Main;

public class Asset_DF_Approval_Test extends BaseClass_ZSM {

	
	
	@Test
	public void Asser_DF_Approval() throws Exception {
	
	
	Asset_DF_Approval_Main ass = PageFactory.initElements(driver , Asset_DF_Approval_Main.class);
	...
	ObjectRepo_Havmor.startTestAndLog_1_SS("Asser_master_Approval_Test_03", "Verify that user Click On DF Approval", () ->{
	Liabrary_Havmor.custom_click(ass.getDF_Approval(), "Click On DF Approval");      
	});
	Thread.sleep(1000);

...
public class Asset_DF_Confirmation_By_Distributor_Main {
	...
	public WebElement getDF_Confirmation_By_Distributor() {
		return DF_Confirmation_By_Distributor;
	}
	...
	@FindBy(how = How.XPATH, using = "//p[normalize-space()='DF Confirmation By Distributor']")
	private WebElement DF_Confirmation_By_Distributor;

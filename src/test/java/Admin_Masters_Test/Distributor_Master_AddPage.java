...
public class Distributor_Master_AddPage extends BaseClass{
	...
	ObjectRepo_Havmor.startTestAndLog_1_SS("Distributor_Master_Test_19", "Verify that user send PinCode", () ->{
		Liabrary_Havmor.custom_Sendkeys(DM.getTxtPinCode(), excel.getStringdata2("Distributor_Add", 1, 8), "send PinCode");
		});
		Thread.sleep(1000);
 
		
	ObjectRepo_Havmor.startTestAndLog_1_SS("Distributor_Master_Test_20", "Verify that user click on State dropdown", () ->{
		Liabrary_Havmor.custom_click(DM.getState_dropdown(), "click on State dropdown");
		});
	Thread.sleep(1000);	
	
	 
	ObjectRepo_Havmor.startTestAndLog_1_SS("Distributor_Master_Test_21", "Verify that user click on State value dropdown", () ->{
		Liabrary_Havmor.custom_click(DM.getState_dropdown_value(), "click on State value dropdown");
		});
		Thread.sleep(1000);	
		
 
	ObjectRepo_Havmor.startTestAndLog_1_SS("Distributor_Master_Test_22", "Verify that user click on City dropdown", () ->{
		Liabrary_Havmor.custom_click(DM.getCity_dropdown(), "click on City dropdown");
		});
		Thread.sleep(1000);	
		
 
	ObjectRepo_Havmor.startTestAndLog_1_SS("Distributor_Master_Test_23", "Verify that user click on City value dropdown", () ->{
	...
	ObjectRepo_Havmor.startTestAndLog_1_SS("Distributor_Master_Test_36", "Verify that user send FSSAI Expiry Date", () ->{
		...
		// scroll to the bottom of the page
				WebElement scroll3 = driver.findElement(By.xpath("//div[@id='ParentMasterContentPlaceHolder1_DocumentLabelDiv']"));
...
//    	ObjectRepo_Havmor.startTestAndLog_1_SS("Distributor_Master_Test_48", "Verify that user click on Close btn", () ->{
//       		Liabrary_Havmor.custom_click(DM.getClose_btn(), "click on Close btn");
//           });
//       	Thread.sleep(1000);

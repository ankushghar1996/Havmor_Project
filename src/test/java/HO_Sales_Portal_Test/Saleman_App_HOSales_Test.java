...
//	Thread.sleep(1000);
	...
	ObjectRepo_Havmor.startTestAndLog_1_SS("SalesMan_Approval_HOSales_Test_05", "Verify that user Click On Proceed for Approval button", () ->{
...
//	Thread.sleep(1000);
	...
	ObjectRepo_Havmor.startTestAndLog_1_SS("SalesMan_Approval_HOSales_Test_06", "Verify that user Click On Yes Button", () ->{

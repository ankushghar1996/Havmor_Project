...
public class Distributor_Master_AddPage extends BaseClass{
	...
	ObjectRepo_Havmor.startTestAndLog_1_SS("Distributor_Master_Test_23", "Verify that user send PAN Number", () ->{
		Liabrary_Havmor.custom_Sendkeys(DM.getTxtpanNumber(), excel.getStringdata2("Distributor_Add", 1, 8), "send PAN Number");
		});
		Thread.sleep(1000);	
	...
	ObjectRepo_Havmor.startTestAndLog_1_SS("Distributor_Master_Test_26", "Verify that user send FSSAI licene number", () ->{
		Liabrary_Havmor.custom_Sendkeys(DM.getTxtFSSAILicense(), excel.getStringdata2("Distributor_Add", 1, 9), "send FSSAI licene number");
		});
		Thread.sleep(1000);	

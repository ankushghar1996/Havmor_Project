...
//		Thread.sleep(1000);
	...
	ObjectRepo_Havmor.startTestAndLog_1_SS("SalesMan_Approval_HOHR_Test_06", "Verify that user Click On Proceed for Approval button", () ->{
	...
	ObjectRepo_Havmor.startTestAndLog_1_SS("SalesMan_Approval_HOHR_Test_08", "Verify that user Click On Yes Button", () ->{

...
public class Salesman_Leave_Details_Report_Main {
	...
	@FindBy(how=How.XPATH,using= "//div[@id='mainDiv']//child::li//p[contains(text(),'Salesman leave detail report')]")
	private WebElement Salesman_Leave_Details_Report;
	...
	public WebElement getSalesman_Leave_Details_Report() {
		return Salesman_Leave_Details_Report;
	}

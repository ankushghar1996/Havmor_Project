...
public class Depot_Select_Sales_Hierarchy_Main {
	...
	@FindBy(how = How.XPATH, using = "//table[@class='rgMasterTable rgClipCells']//tr//td//a[@id='ctl00_ParentMasterContentPlaceHolder1_radGridDepotMaster_ctl00_ctl08_btnAreaMapping']")
